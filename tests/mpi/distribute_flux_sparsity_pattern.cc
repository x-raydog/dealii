...
/*
 * Verify that the current commit fixes distributed flux sparsity
 * patterns. This fixes a bug where (see the commit for more details) coupling
 * between an active, locally owned cell and an active ghost cell may be
 * erroneously skipped when building a sparsity pattern with flux terms.
 */
