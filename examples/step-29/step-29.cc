...
namespace Step29
{
  ...
  template <int dim>
  void
  UltrasoundProblem<dim>::make_grid()
  {
  ...
  template <int dim>
  void
  UltrasoundProblem<dim>::setup_system()
  {
  ...
  template <int dim>
  void
  UltrasoundProblem<dim>::assemble_system()
  {
  ...
  template <int dim>
  void
  UltrasoundProblem<dim>::output_results() const
  {
