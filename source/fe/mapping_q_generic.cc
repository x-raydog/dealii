      ...
      for (unsigned int line_no=0; line_no<GeometryInfo<dim>::lines_per_cell; ++line_no)
        {
          ...
          if (const Boundary<dim,spacedim> *boundary
          ...
          else
            {
              ...
              vertices[0] = cell->vertex(GeometryInfo<dim>::line_to_cell_vertices(line_no, 0));
              vertices[1] = cell->vertex(GeometryInfo<dim>::line_to_cell_vertices(line_no, 1));
  ...
  for (unsigned int face_no=0; face_no<faces_per_cell; ++face_no)
    {
      ...
      if (boundary != nullptr &&
      ...
      else
        {
          ...
          // the four lines
          boost::container::small_vector<Point<3>, 20>
